...
class FileStorage:
    ...
    def all(self, cls=None):
        ...
        Args:
            cls (class, optional): If specified, filters the result to
            include only objects of the specified class.
    ...
    def delete(self, obj=None):
        """
        Deletes obj from __obj if it is inside and if obj is equal to
